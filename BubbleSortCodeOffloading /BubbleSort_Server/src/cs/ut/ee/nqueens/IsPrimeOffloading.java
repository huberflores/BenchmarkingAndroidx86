...
public class IsPrimeOffloading extends Activity {
...
MessageReceiver receiver;
    ...
    private void changelabelcloud(String Bubbleintent){
     TextView tv1 = (TextView)this.findViewById(R.id.label);
     tv1.setText(Bubbleintent);
    }
    ...
    private void changelabellocal(String Bubbleintent){
    ...
    public class MessageReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
         ...
         if(iscloud){
         String Bubbleintent = intent.getStringExtra("Bubbleintent");
                
                changelabelcloud(Bubbleintent);
         }else{
         String BubbleLocalintent = intent.getStringExtra("Bubbleintent");
                
                changelabellocal(BubbleLocalintent);
         }
         try {
      ...
      public void onResume() {
        IntentFilter filter;
        filter = new IntentFilter(IsPrimeOffloading.changelabel);
